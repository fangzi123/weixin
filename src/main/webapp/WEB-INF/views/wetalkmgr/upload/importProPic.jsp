    ...
    <div class="container contain_width">
	    <form>
            <fieldset>
				...
				第二步 导入项目图片(点击选择图片):<br/>
				第三步 项目房源录入:<a href="<%=contextPath%>/upload/toimportHouse?projectId=${projectId}&brandName=${brandName}&communityName=${communityName}">房源录入</a><br/>
				<div id="box" >
					<div id="test"></div>
				</div>
...
*/
$('#test').diyUpload({
	url:'imageupload?projectId=${projectId}',
