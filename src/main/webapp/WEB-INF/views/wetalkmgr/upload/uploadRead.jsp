...
<head>
	...
	<link rel="shortcut icon" href="<%=pageContext.getServletContext().getContextPath()%>/images/logo/favicon.ico" type="image/x-icon" />
</head>
...
<body>
	...
	<div class="container contain_width" >
		<div class="row row_width" >
			<div class="span12">
 			<form action="displayUpload.html" id="uploadForm" method="post" class="form-horizontal" enctype="multipart/form-data">
				<fieldset>
					<div id="legend">
					   ...
					   <div class="span8">
						<div class="row">
							<div class="control-group">
								<label class="control-label" for="fileType"><fmt:message key="upload_fileType" /></label>
							 	<div class="controls">
							 		<input type="hidden" name="fileTypeValue" value="${fileTypeValue}">
									<select name="fileType" style="height:24px;line-height: 22px;width:553px" id="fileType_Id">
						...
						<div class="row">
							<div class="control-group">
								...
								<div class="controls">
									<input type="file" id="file" name="file" style="height:24px;line-height: 22px;width:553px"/>
								</div>
						...
						<div style="float:right;margin-left:1px;">
							<div style="padding-top:0px;">
						    	...
						    	<img title="<fmt:message key="query" />" src="<%=contextPath%>/images/search.png" id="searchBtn" style="cursor: pointer;">
							</div>
						</div>
						<div  style="float:right">
							<div style="padding-top:0px;">
							   	<img title=<fmt:message key="submit" /> src="<%=contextPath%>/images/submit.png" id="submitBtn" style="cursor: pointer;">
							</div>
						</div>
