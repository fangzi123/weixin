	...
	<body>
		<div class="container-fluid div_title woniu-box-center">
		        ...
		        <div class="span12" id="sec-03" >
	    	        <p class="p-txt">在北京生活，租房是件太过寻常的事情，平均每三人中就有一个是租客。随着消费水平的提高，租客对生活品质的要求也相应上涨。近年来，市场应运出现了一批专业的公寓公司，致力于提供一站式的租住服务，大大提升了租客体验。</p>
			        <p class="p-txt">这些都让租房真正的成为了一个行业，大而全的传统网站已经很难满足快速发展的需求。而窝牛租房，作为一家专注于长租公寓这个垂直领域的B2C平台，能够真正解决租客与公寓公司双方信息不对称的问题，为每一位租客找到最适合自己的房源。</p>
		        </div>
		        <div class="span12">
