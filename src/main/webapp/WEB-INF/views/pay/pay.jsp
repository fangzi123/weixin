...
<body>
	<img class="bg" src="<%=contextPath %>/images/activity/1210shilihe/man-box-3.png" >
    ...
    <form id="pay_form" action="confirmPay" method="post">
        <c:if test="${empty error}">
            <div class="div-house-inf">
                <div class="row">
                    <input type="button" value="支付" id="btnPay" class="input-height-lg bg-yellow" style="width: 100%;" onclick="callpay();"/>
                </div>
            </div>
        </c:if>
