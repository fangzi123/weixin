			...
			<div class="plr10">
   				<ul class="form-list">
  					...
  					<li class="list">
   						...
   						<div class="right" align="right">${house.communityName}${house.doorplate}号${house.buildingNo}楼${house.roomNumber}室</div>
  					</li>
  					<li class="list">
  					...
  					<li class="list">
   						...
   						<div class="right" align="right">2014年9月12日</div>
  					</li>
  					<li class="list">
  					...
  					<li class="list">
   						...
   						<div class="right">
     						<div class="inputbox"><input type="text" class="input01" /></div>
   						</div>
  					</li>	
  				</ul>
  				<div class="ty"><input type="checkbox" />同意 <a href="#">《须知》</a></div>
    			<div class="btnbox"><a href="#" class="btn01">确认支付</a></div>
			</div>
		</section>
		<!--主题部分结束-->
	</body>
