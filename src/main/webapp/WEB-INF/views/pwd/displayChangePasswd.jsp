				...
				<div class="row">
					...
					<div class="row">
						<div class="control-group span6">
							...
							<div class="controls">
								<input type="password" id="oldPasswd" name="oldPasswd" value="" class="input-large" style="height:20px;" />
								<input type="hidden"   id="username" name="username" value="<shiro:principal property="userName"/>" />
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="control-group span6">
							...
							<div class="controls">
								<input type="password" id="newPasswd" name="newPasswd" value="" class="input-large" style="height:20px;" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="control-group span6">
							...
							<div class="controls">
								<input type="password" id="newPasswdAgain" name="newPasswdAgain" value="" class="input-large" style="height:20px;"/>
							</div>
						</div>
					</div>
					<div class="control-group span6">
