...
<html>
	<head>
		...
		<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=A122a2bb3e8ff58a9490406760e978f9"></script>
        <script type="text/javascript" src="<%=contextPath%>/mvcjs/myrent/match.js"></script>
        
        <style type="text/css">
             .e9 {color:#878787;*display:inline-block;*line-height:15px;}
             .wrong_box {background-color:#0;border:0px solid #ffb8b8;color:#f40000; display:inline-block;height:15px;line-height:15px;padding:0 0px;_padding-top:0px;_height:15px;}
   ...
   <img src="/img/20141106/20141106131044hou_pic/H_110000010001_2_1.JPG"/>
					...
					<li class="list">
						...
						<div class="right">
							<div class="inputbox">
								<input type="text" class="input01 combo" name="longPrice" id="longPrice" value="${longPrice}" />
							</div>
						</div>
						<div class="right">
	...
	<div  class="nav4">
		<nav>
			...
			<ul class="box">
                ...
                <li>
					<a href="<%=contextPath%>/rental/map/displayMap.html?weixinId=${weixinId}" class=""><span>租房地图</span></a>
                </li>
