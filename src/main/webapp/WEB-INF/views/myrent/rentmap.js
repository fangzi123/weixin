...
//	});
	...
	var currentPoIcon = new BMap.Icon("/images/my_place.png", 
			new BMap.Size(19,25), 
	...
	/************************************ 聚合点模式***************************************/
	var markers = [];
	var yellowIcon = new BMap.Icon("/images/marker_org_sprite.png",
			new BMap.Size(19,25),
			{anchor: new BMap.Size(8, 25)});
	var hotIcon = new BMap.Icon("/images/marker_red_sprite.png", 
			new BMap.Size(19,25),
			{anchor: new BMap.Size(8, 25)});
...
//	markerClusterer.setMinClusterSize(2);
	...
	/*var markerUnclick = 
		  '<div style="position: absolute;' +
		  			  ...
		  			  'left: -10px;' +
		  			  'top: -35px;' + 
		  			  'background-image: url(' + '/images/house-uncheck.png);' +
		  			  'overflow: hidden;">'  + 	
		  '</div>' + 
	...
	var markerClick = 
		  '<div style="position: absolute;' +
			  		  ...
			  		  'left: -10px;' +
			  		  'top: -35px;' + 
			  		  'background-image: url(' + '/images/house-check.png);' +
			  		  'overflow: hidden;">'  + 	
		  '</div>' + 
		  '<div class="BMapLabel" unselectable="on"' +
			   'style="position: absolute;' + 
	...
	$.each(arrPoint, function(index) {
		...
		marker.addEventListener("click", function(e) {
			$("div.BMapLabel").prev().css("background-image", "url(" + '/images/house-uncheck.png)');
	...
	function getFlatsPicture(e) {
		...
		$.ajax({
             type: "GET",
             url: "/rental/rental/map/displayProject",
             data: {projectId:marker.projectId,layout:layout,longPrice:longprice,communityName:marker.communityName},
             dataType: "json",
