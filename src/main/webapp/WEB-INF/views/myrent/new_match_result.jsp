...
<body>
	<div id="content">
		<c:forEach items="${houseList}" var="item" varStatus="cur">
			<div class="container-fluid">
				<div class="row" onclick="location='<%=contextPath%>/rental/match/detail?houseId=${item.houseId}&weixinId=${weixinId}&duration=${item.duration}'">
					<div class="div-img">
	...
	<div id="lodaing" style="<c:if test="${fn:length(houseList) <10}">display:none;</c:if>" class="woniu-box-center font-big">
		正在加载中
		<div class="point">·</div>
