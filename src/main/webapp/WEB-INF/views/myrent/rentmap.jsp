...
<head>
	...
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=1.9&ak=108b50eb45abfdb30d056ec907130e22"></script>
	<!-- 富标签 -->
...
<body>
	<div id="map_area">
		<a href="<%=contextPath%>/rental/map/filterMap?weixinId=${weixinId}"><img id="change" src="<%=contextPath%>/images/change.png"></img></a>
		<div id="l-map"></div>
	</div>
	<div id="div_pictupre">
